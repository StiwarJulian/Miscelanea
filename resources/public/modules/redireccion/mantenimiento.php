                            ...
                            <div class="card border-grey border-lighten-3 px-1 py-1 box-shadow-3 m-0">
                                <div class="card-body">
                                    <span class="card-title text-center">
                                        <h3>AUTOEVALUACION ARTEPE SA</h3>
                                    </span>
                                </div>
                                <div class="card-body text-center">
                                    <h3>La plataforma actualmente se encuentra en mantenimiento</h3>
                                    <p>Lamentamos las molestias,
                                        <br>Porfa espere mientras la base de datos se esta cargando.</p>
                                    <div class="mt-2"><i class="la la-cog spinner font-large-2"></i></div>
                                </div>
                                <span class="card-title text-center">
                                    JUAN ARLEY CUERO - DIRECTOR DE TECNOLOGIA
                                </span> 
                                <a href="http://autoevaluacion.ml/" class="btn btn-primary btn-block"><i class="ft-home"></i> SITIO WEB : Autoevaluacion app beta</a>
                                <hr>
