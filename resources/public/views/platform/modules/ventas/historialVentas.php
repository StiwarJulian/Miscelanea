            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Modulo de Ventas</h4>
                        ...
                        <div class="card">
                            <div class="card-body"  id="smgProductosBusqueda">
                                <div class='d-md-flex align-items-center'>
                                    <div class='col-sm-8'>
                                        <h4 class='card-title'>Historial Ventas </h4>
                                        <h5 class='card-subtitle'>Ventas Del Mes - Ultima Actualizacion - 11/12/2019 - Estado: <span class='badge badge-success'>Actualizado</span></h5>        
                                    </div>
                                </div>
                                <table class='table'>
                                    <thead>
