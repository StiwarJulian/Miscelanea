            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Cantidades</h4>
                    ...
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-cyan text-center">
                                ...
                                <h6 class="text-white">Productos Disponibles</h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-warning text-center">
                                ...
                                <h6 class="text-white">Productos A Acabarse</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                ...
                                <h6 class="text-white">Productos Vendidos</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    <div class="col-md-6 col-lg-3 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-info text-center">
                                ...
                                <h6 class="text-white">Productos Fiados</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                ...
                <div class="row">
                    <div class="col-md-12" id='list'>
                        <div class="card">
                            <div class="card-body" id='smgProductosBusqueda'>
                                <?php $productosController = productosController::listarProductosActivos();?>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3" id='cart' style="display:none">
                        <?php  
                            ...
                            productosController::addCart(16);                        
                        ?>
                    </div>
                </div>
                <!-- ============================================================== -->
